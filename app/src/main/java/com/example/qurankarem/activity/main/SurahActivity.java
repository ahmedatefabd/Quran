...
import com.example.qurankarem.adapter.SurahAdapter;
import com.example.qurankarem.model.Surah;
import com.example.qurankarem.modelDB.SurahDB;
import com.example.qurankarem.util.NetworkChangeReceiver;
import com.example.qurankarem.util.Utils;
import java.util.List;
import java.util.Locale;
import static android.os.Build.VERSION_CODES.M;

public class SurahActivity extends AppCompatActivity implements SurahView{

    public static Toolbar toolbar;
    public static ShimmerRecyclerView shimmerRecyclerView;
    private SurahPresenter surahPresenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        surahPresenter = new SurahPresenterImp();
        surahPresenter.setView(this);
        ShimmerRecycler();
