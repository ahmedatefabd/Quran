package com.example.qurankarem.activity.splash;
...
import com.example.qurankarem.activity.main.SurahActivity;
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                handler.postDelayed(new Runnable() {
                    public void run() {
                        try {
                            Intent i;
                            i = new Intent(SplashActivity.this, SurahActivity.class);
                            startActivity(i);
                            finish();
                        } catch (Exception e) {
                        }
